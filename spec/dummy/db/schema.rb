...
ActiveRecord::Schema.define(:version => 20121024152645) do
  ...
  create_table "oauth2_available_scopes", :force => true do |t|
    t.integer "client_id"
    t.string  "scope_name"
  end
  ...
  create_table "oauth2_enabled_scopes", :force => true do |t|
    t.integer "user_id"
    t.integer "available_scope_id"
  end
